...
export const APP_MANAGED_SERVER_OPTION_ALIASES = {
  ...
  "--mmproj": ["--mmproj", "-mm", "--mmproj-url", "-mmu", "--mmproj-auto", "--no-mmproj", "--no-mmproj-auto"],
  ...
  "--spec-draft-ngl": ["--spec-draft-ngl", "--gpu-layers-draft", "--n-gpu-layers-draft", "-ngld"],

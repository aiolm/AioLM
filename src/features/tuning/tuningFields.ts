...
import { CACHE_TYPE_OPTIONS, MIROSTAT_OPTIONS } from "../../shared/config/tuningValidation";
...
export type TuningTooltip = TooltipContent;
...
type FieldTranslator = (key: import("../../shared/i18n/i18nUnified").UnifiedKey, vars?: import("../../shared/i18n/i18nUnified").TranslationVars) => string;
...
function translateFieldKey(
  ...
  const translated = t(key as import("../../shared/i18n/i18nUnified").UnifiedKey);
